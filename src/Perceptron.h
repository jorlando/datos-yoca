...
private:
	...
	vector<float> entrenamiento(vector<float> pesos, int cant_mas_bias);
	vector<float> clasificoTests(vector<float> result_test, int cant_mas_bias, vector<float> pesos);
